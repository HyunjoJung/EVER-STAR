  ...
  theme: {
    ...
    extend: {
      colors: {
        ...
        // Custom colors from hardcoded values
        required: '#fd2929',
        'tab-active': '#ff9078',
        'tab-active-text': '#f28c76',
        'tab-inactive': '#dbe4eb',
        'tab-border': '#c3c9d3',
        'text-dark': '#1f2329',
        'shadow-color': '#dbe5ec',
        ...
        'postit-green': '#D6F8CF',
        'postit-blue': '#CFEEF8',
        'postit-purple': '#E6CFFF',
        'postit-yellow': '#FFF9CF',
        'postit-gray': '#E8E8E8',
      },
      fontFamily: {
        ...
        // Custom fonts from hardcoded values
        kyobo: ["'Kyobo_Handwriting_2019-Regular'", 'Helvetica'],
        'noto-bold': ["'Noto_Sans_KR-Bold'", 'Helvetica'],
      },
      fontSize: {
        'kor-h-h1': [
          '24px',
