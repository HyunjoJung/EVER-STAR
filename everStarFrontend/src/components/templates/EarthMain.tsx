...
// Firebase disabled for frontend-only portfolio - no backend to send notifications
...
export const EarthMain: React.FC<EarthMainProps> = ({
  ...
  // Firebase completely disabled for frontend-only portfolio
  ...
  // Firebase messaging disabled for frontend-only portfolio
  // if (messaging) {
