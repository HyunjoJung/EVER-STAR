...
export const Profile: React.FC = () => {
  ...
  if (isLoading) {
    return (
      <div 
        className='relative flex flex-col items-start min-h-screen bg-center bg-cover z-[-1]'
  ...
  if (error) return <div className='text-red-500' data-testid="profile-error">{error.message}</div>;
