...
import com.everstarbackmain.domain.user.requestDto.AuthenticateUserRequestDto;
...
public class User extends BaseTimeEntity {
	...
	/**
	 * OAuth 사용자(ROLE_GUEST)를 정식 사용자(ROLE_USER)로 전환
	 */
	public void authenticateUser(AuthenticateUserRequestDto requestDto) {
		...
		this.questReceptionTime = requestDto.getQuestReceptionTime();
