...
public enum CustomException {
	...
	INVALID_BASE64_FORMAT(400, "InvalidBase64Format", "잘못된 Base64 형식입니다."),
	S3_UPLOAD_EXCEPTION(400, "S3UploadException", "파일 업로드를 실패했습니다."),
	AZURE_BLOB_UPLOAD_EXCEPTION(400, "AzureBlobUploadException", "Azure Blob Storage 파일 업로드를 실패했습니다."),
	AZURE_BLOB_DELETE_EXCEPTION(400, "AzureBlobDeleteException", "Azure Blob Storage 파일 삭제를 실패했습니다."),
	...
	VERTEX_AI_EXCEPTION(400, "VertexAiException", "Vertex AI API 사용 중 예외가 발생했습니다."),
	...
	NOT_MATCH_AUTH_CODE_EXCEPTION(400, "NotMatchAuthCodeException", "인증 코드가 일치하지 않습니다."),
	DUPLICATED_PHONENUMBER_EXCEPTION(400, "DuplicatedPhoneNumberException", "이미 사용중인 전화번호입니다."),
	NOT_AUTH_PHONE_NUMBER(400, "NotAuthPhoneNumber", "인증되지 않은 전화번호입니다."),
	NOT_EXIST_REGISTRATIONID(400, "NotExistRegistrationId", "존재하지 않는 OAuth 제공자입니다."),
	...
	NOT_EXIST_CHAT_ROOM(404, "NotExistChatRoom", "채팅방이 존재하지 않습니다."),
	NOT_EXIST_EMAIL(404, "NotExistEmail", "존재하지 않는 이메일입니다."),
	EXIST_EMAIL(409, "ExistEmail", "이미 사용중인 이메일입니다."),
